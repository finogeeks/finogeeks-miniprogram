"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var taro = require("../../taro/index.js");function _typeof(e) {
  ...
  var ReactPropTypesSecret$1 = ReactPropTypesSecret_1,
      loggedTypeFailures = {};printWarning = function (e) {
  ...
  for (var a in e) if (e.hasOwnProperty(a)) {
    var i;try {
      if ("function" != typeof e[a]) {
        var s = Error((r || "React class") + ": " + n + " type `" + a + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + _typeof(e[a]) + "`.");throw s.name = "Invariant Violation", s;
      }i = e[a](t, a, r, n, null, ReactPropTypesSecret$1);
    } catch (e) {
      i = e;
    }if (!i || i instanceof Error || printWarning((r || "React class") + ": type specification of " + n + " `" + a + "` is invalid; the type checker function must return `null` or an `Error` but returned a " + _typeof(i) + ". You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument)."), i instanceof Error && !(i.message in loggedTypeFailures)) {
      loggedTypeFailures[i.message] = true;var c = o ? o() : "";printWarning("Failed " + n + " type: " + i.message + (null != c ? c : ""));
    }
  }
...
};var factoryWithTypeCheckers = function (i, f) {
  var a = "function" == typeof Symbol && Symbol.iterator,
      ...
      return n(function (e, t, n, r, o) {
        if ("function" != typeof c) return new y("Property `" + o + "` of component `" + n + "` has invalid PropType notation inside arrayOf.");var a = e[t];if (!Array.isArray(a)) return new y("Invalid " + r + " `" + o + "` of type `" + h(a) + "` supplied to `" + n + "`, expected an array.");for (var i = 0; i < a.length; i++) {
          var s = c(a, i, n, r, o + "[" + i + "]", ReactPropTypesSecret_1);if (s instanceof Error) return s;
        }return null;
      });
    }, element: n(function (e, t, n, r, o) {
      var a = e[t];return i(a) ? null : new y("Invalid " + r + " `" + o + "` of type `" + h(a) + "` supplied to `" + n + "`, expected a single ReactElement.");
    }), instanceOf: function (s) {
      return n(function (e, t, n, r, o) {
        if (e[t] instanceof s) return null;var a,
            i = s.name || d;return new y("Invalid " + r + " `" + o + "` of type `" + ((a = e[t]).constructor && a.constructor.name ? a.constructor.name : d) + "` supplied to `" + n + "`, expected instance of `" + i + "`.");
      });
    }, node: n(function (e, t, n, r, o) {
      return c(e[t]) ? null : new y("Invalid " + r + " `" + o + "` supplied to `" + n + "`, expected a ReactNode.");
    }), objectOf: function (p) {
      return n(function (e, t, n, r, o) {
        if ("function" != typeof p) return new y("Property `" + o + "` of component `" + n + "` has invalid PropType notation inside objectOf.");var a = e[t],
            i = h(a);if ("object" !== i) return new y("Invalid " + r + " `" + o + "` of type `" + i + "` supplied to `" + n + "`, expected an object.");for (var s in a) if (a.hasOwnProperty(s)) {
          var c = p(a, s, n, r, o + "." + s, ReactPropTypesSecret_1);if (c instanceof Error) return c;
        }return null;
      });
    }, oneOf: function (p) {
      return Array.isArray(p) ? n(function (e, t, n, r, o) {
        for (var a = e[t], i = 0; i < p.length; i++) if (s = a, c = p[i], s === c ? 0 !== s || 1 / s == 1 / c : s != s && c != c) return null;var s, c;return new y("Invalid " + r + " `" + o + "` of value `" + a + "` supplied to `" + n + "`, expected one of " + JSON.stringify(p) + ".");
      }) : (printWarning$1("Invalid argument supplied to oneOf, expected an instance of array."), emptyFunctionThatReturnsNull);
    }, oneOfType: function (i) {
      if (!Array.isArray(i)) return printWarning$1("Invalid argument supplied to oneOfType, expected an instance of array."), emptyFunctionThatReturnsNull;for (var e = 0; e < i.length; e++) {
        ...
        for (var a = 0; a < i.length; a++) if (null == (0, i[a])(e, t, n, r, o, ReactPropTypesSecret_1)) return null;return new y("Invalid " + r + " `" + o + "` supplied to `" + n + "`.");
      });
    }, shape: function (u) {
      return n(function (e, t, n, r, o) {
        var a = e[t],
            i = h(a);if ("object" !== i) return new y("Invalid " + r + " `" + o + "` of type `" + i + "` supplied to `" + n + "`, expected `object`.");for (var s in u) {
          var c = u[s];if (c) {
      ...
      return n(function (e, t, n, r, o) {
        var a = e[t],
            i = h(a);if ("object" !== i) return new y("Invalid " + r + " `" + o + "` of type `" + i + "` supplied to `" + n + "`, expected `object`.");var s = objectAssign({}, e[t], l);for (var c in s) {
          var p = l[c];if (!p) return new y("Invalid " + r + " `" + o + "` key `" + c + "` supplied to `" + n + "`.\nBad object: " + JSON.stringify(e[t], null, "  ") + "\nValid keys: " + JSON.stringify(Object.keys(l), null, "  "));var u = p(a, c, n, r, o + "." + c, ReactPropTypesSecret_1);if (u) return u;
        }return null;
      });
    } };function y(e) {
    ...
    var u = {},
        l = 0;function e(e, t, n, r, o, a, i) {
      if (r = r || d, a = a || n, i !== ReactPropTypesSecret_1) {
        if (f) {
          ...
          var c = r + ":" + n;!u[c] && l < 3 && (printWarning$1("You are manually calling a React.PropTypes validation function for the `" + a + "` prop on `" + r + "`. This is deprecated and will throw in the standalone `prop-types` package. You may be seeing this warning due to a third-party PropTypes library. See https://fb.me/react-warning-dont-call-proptypes for details."), u[c] = true, l++);
        }
      }return null == t[n] ? e ? null === t[n] ? new y("The " + o + " `" + a + "` is marked as required in `" + r + "`, but its value is `null`.") : new y("The " + o + " `" + a + "` is marked as required in `" + r + "`, but its value is `undefined`.") : null : p(t, n, r, o, a);
    }var t = e.bind(null, false);return t.isRequired = e.bind(null, true), t;
  }function t(s) {
    return n(function (e, t, n, r, o, a) {
      var i = e[t];return h(i) === s ? null : new y("Invalid " + r + " `" + o + "` of type `" + p(i) + "` supplied to `" + n + "`, expected `" + s + "`.");
    });
  }function c(e) {
    switch (_typeof(e)) {case "number":case "string":case "undefined":
        return true;case "boolean":
        return !e;case "object":
        if (Array.isArray(e)) return e.every(c);if (null === e || i(e)) return true;var t = function (e) {
          var t = e && (a && e[a] || e[s]);if ("function" == typeof t) return t;
        }(e);if (!t) return false;var n,
            r = t.call(e);if (t !== e.entries) {
          for (; !(n = r.next()).done;) if (!c(n.value)) return false;
        } else for (; !(n = r.next()).done;) {
          var o = n.value;if (o && !c(o[1])) return false;
        }return true;default:
        return false;}
  }function h(e) {
    var t,
        n = _typeof(e);return Array.isArray(e) ? "array" : e instanceof RegExp ? "object" : (t = e, "symbol" === n || "Symbol" === t["@@toStringTag"] || "function" == typeof Symbol && t instanceof Symbol ? "symbol" : n);
  }function p(e) {
    if (null == e) return "" + e;var t = h(e);if ("object" === t) {
      if (e instanceof Date) return "date";if (e instanceof RegExp) return "regexp";
    }return t;
  }function r(e) {
    var t = p(e);switch (t) {case "array":case "object":
        return "an " + t;case "boolean":case "date":case "regexp":
        return "a " + t;default:
        return t;}
  }return y.prototype = Error.prototype, e.checkPropTypes = checkPropTypes_1, e.PropTypes = e;
  ...
  {
    var t = "function" == typeof Symbol && Symbol.for && Symbol.for("react.element") || 60103;e.exports = factoryWithTypeCheckers(function (e) {
      return "object" === _typeof(e) && null !== e && e.$$typeof === t;
    }, true);
  }
});function shallowEqual(e, t) {
  if (null === e && null === t) return true;if (null === e || null === t) return false;if (Object.is(e, t)) return true;var n = e ? Object.keys(e) : [],
      r = t ? Object.keys(t) : [];if (n.length !== r.length) return false;for (var o = 0; o < n.length; o++) {
    var a = n[o];if (!t.hasOwnProperty(a) || !Object.is(e[a], t[a])) return false;
  }return true;
...
};var freeGlobal = "object" == _typeof(commonjsGlobal) && commonjsGlobal && commonjsGlobal.Object === Object && commonjsGlobal,
  ...
  var t = hasOwnProperty$1.call(e, symToStringTag),
    ...
    var r = !(e[symToStringTag] = undefined);
  } catch (e) {}var o = nativeObjectToString.call(e);return r && (t ? e[symToStringTag] = n : delete e[symToStringTag]), o;
  ...
  return e && (r = "component" === n ? (r = e.selectComponent(t)) ? r.$component || r : null : wx.createSelectorQuery().in(e).select(t)) || null;var r;
  ...
  var r;if (t = t || [], "componentDidMount" === e && n.$$refs && 0 < n.$$refs.length) {
    var o = {};n.$$refs.forEach(function (e) {
      var t;t = "component" === e.type ? (t = n.$scope.selectComponent("#".concat(e.id))) ? t.$component || t : null : wx.createSelectorQuery().in(n.$scope).select("#".concat(e.id)), taro.commitAttachRef(e, t, n, o, true), e.target = t;
...
}var isDEV = "undefined" == typeof process || !process.env || true;function hasNewLifecycle(e) {
  ...
  var e = n.state,
      o = n.props,
      a = undefined === o ? {} : o,
      i = e || {};if (n._createData) {
    var s = !n.__mounted;n.__isReady && (injectContextType(n), taro.Current.current = n, taro.Current.index = 0, taro.invokeEffects(n, true)), i = n._createData(e, a, s) || i, n.__isReady && (taro.Current.current = null);
  }if (i = Object.assign({}, a, i), n.$usedState && n.$usedState.length) {
    var c = {};n.$usedState.forEach(function (e) {
      var t = taro.internal_safe_get(i, e);if (undefined !== t) if ("object" === _typeof(t)) {
        if (isEmptyObject(t)) return taro.internal_safe_set(c, e, t);isEmptyObject(t = shakeFnFromObject(t)) || taro.internal_safe_set(c, e, t);
      } else taro.internal_safe_set(c, e, t);
    }), i = c;
  }i.$taroCompReady = true;var p,
      u = diffObjToPath(i, n.$scope.data),
      l = n.__mounted;l && (p = callGetSnapshotBeforeUpdate(n, t, r));var f = [];function d() {
    if (l && (taro.invokeEffects(n), n.$$refs && 0 < n.$$refs.length && n.$$refs.forEach(function (e) {
      if ("component" === e.type) {
        var t = n.$scope.selectComponent("#".concat(e.id));(t = t ? t.$component || t : null) !== e.target && (taro.commitAttachRef(e, t, n, n.refs), e.target = t);
      }
    }), n.$$hasLoopRef && (n._disableEffect = true, n._createData(n.state, n.props, true), n._disableEffect = false), isFunction(n.componentDidUpdate) && n.componentDidUpdate(t, r, p)), f.length) for (var e = f.length; 0 <= --e;) "function" == typeof f[e] && f[e].call(n);
  }n._pendingCallbacks && n._pendingCallbacks.length && (f = n._pendingCallbacks, n._pendingCallbacks = []), 0 === Object.keys(u).length ? d() : n.$scope.setData(u, d);
}var items = [];function enqueueRender(e) {
  !e._dirty && (e._dirty = true) && 1 === items.push(e) && nextTick(rerender);
}function rerender() {
  var e,
  ...
  var t = Object.assign({}, taro.onAndSyncApis, taro.noPromiseApis, taro.otherApis),
    ...
    b in wx ? taro.onAndSyncApis[b] || taro.noPromiseApis[b] ? e[b] = function () {
      ...
      for (var e = arguments.length, t = new Array(1 < e ? e - 1 : 0), n = 1; n < e; n++) t[n - 1] = arguments[n];o = o || {};var r,
        ...
        }), a = t.length ? (e = wx)[b].apply(e, [i].concat(t)) : wx[b](i);
