...
var _search = require("../../store/actions/search.js");
...
var Home = (_dec = (0, _index3.connect)(mapStateToProps), _dec(_class = function (_BaseComponent) {
  ...
  function Home() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = Home.__proto__ || Object.getPrototypeOf(Home)).call.apply(_ref2, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "anonymousState__temp2", "loopArray3", "$compid__16", "showNavBar", "searchState", "searchResult", "searchTypes", "moreImg", "scrollHeight", "hasMobile", "navBarHeight"], _this.checkoutConsultRoom = false, _this.isShow = false, _this.config = {
      ...
      var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(eve) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                channelInfo = channelInfo.filter(function (e) {
                  return !localChannelRoom.some(function (l) {
                    return l.id === e.room_id;
                  });
                });
    ...
    }(), _this.goToTypeSearch = function (item) {
      console.log('============goToTypeSearch============');
      console.log(item);
      _index5.default.dispatch((0, _search.updateSearch)({ searchResult: item }));
      _index2.default.navigateTo({
        url: '/pages/type-search/index'
      });
    }, _this.enterRoom = function () {
      var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(roomId) {
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _im2.default.enterRoom(roomId);
    ...
    }(), _this.enterSearchRoom = function () {
      var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(room) {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                console.log(room);
                if (room.isLocal) {
                  _this.enterRoom(room.id || room.room_id);
                } else {
  ...
  _createClass(Home, [{
    ...
    value: function _createData() {
      ...
      var anonymousState__temp2 = (0, _index.internal_inline_style)({ height: scrollHeight + "px", 'margin-top': searchHeight + "px" });
      var loopArray3 = !(searchState === 'none') ? searchResult.map(function (item, _anonIdx3) {
        item = {
          $original: (0, _index.internal_get_original)(item)
        };
        var $anonymousCallee__0 = !(searchState === 'none') ? item.$original.shotrlist.map(function (e, _anonIdx) {
          e = {
            $original: (0, _index.internal_get_original)(e)
          };
          var $compid__15 = (0, _index.genCompid)(__prefix + "tnXShQTaoS" + _anonIdx3 + "-" + _anonIdx);
...
Home.$$events = ["enterSearch", "beginSearch", "handleClickBack", "goToTypeSearch", "enterSearchRoom"];
Home.$$componentPath = "pages/globalsearch/index";
