...
var TextMessage = function (_BaseComponent) {
  ...
  function TextMessage() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TextMessage.__proto__ || Object.getPrototypeOf(TextMessage)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["message", "nodes"], _this.handleLink = function (url) {
      // 临时取消 url 校验
  ...
  _createClass(TextMessage, [{
    ...
    value: function _createData() {
      ...
      var nodes = this.getNodes(message.content.dsbody || message.content.body);
...
TextMessage.$$events = [];
TextMessage.$$componentPath = "components/message/text-message/index";
